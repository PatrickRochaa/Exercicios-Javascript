...
if (media <3){
    ...
    var nota = ' em <mark style= "background-color: yellow"> RECUPERAÇÃO</mark>'
...
res.innerHTML = `<h1>Analisando a situação de ${nome}</h1>`
 res.innerHTML += `com as notas ${nota1} e ${nota2} a <strong>  média é ${media}</strong><br><br>`
 res.innerHTML += `com media ${entre}, o aluno está ${nota}`
}